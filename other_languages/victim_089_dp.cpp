...
// [MEMORY_LIMIT_MB]: 256
// [N_CONSTRAINT]: 200000
// [INPUT_FORMAT]: An integer T (test cases). For each test case: an integer N, then a string S of length N

forces", "string" are anti-palindromes, but the strings "abacaba", "abc", "test" are not.
